...
于是
\begin{gather}
\theta _M=\mathrm{arc}\tan \frac{y_M}{x_M},
\\
\tan \frac{v_0t}{2r}=2r\left( \theta _{P_0\left( t \right)}-\theta _M \right) .
\end{gather}
解出$\theta _{P_0\left( t \right)}$代入$\wideparen{MG}$的极坐标方程得
\begin{align}
x_{\theta _{P_0\left( t \right)}}=x_{O_1}+2r\cos \theta _{P_0\left( t \right)},
\\
y_{\theta _{P_0\left( t \right)}}=y_{O_1}+2r\sin \theta _{P_0\left( t \right)}.
\end{align}
...
于是
\begin{gather}
\theta _G=\mathrm{arc}\tan \frac{y_G}{x_G},
\\
\tan v_0\left( t-\frac{L_1}{v_0} \right) =r\left( \theta _{P_0\left( t \right)}-\theta _G \right) .
\end{gather}
解出$\theta _{P_0\left( t \right)}$代入$\wideparen{GN}$的极坐标方程得
\begin{align}
x_{\theta _{P_0\left( t \right)}}=x_{O_2}+r\cos \theta _{P_0\left( t \right)},
\\
y_{\theta _{P_0\left( t \right)}}=y_{O_2}+r\sin \theta _{P_0\left( t \right)}.
\end{align}
