...
\end{array} \right. 
\end{align}
\par 由问题一中模型，同理得到 $t$ 时刻$(t\in \left[ \underset{i=1,2,3,4,5}{\min}\left\{ t_{FYj,12} \right\} ,\underset{i=1,2,3,4,5}{\max}\left\{ t_{FYj,32} \right\} +\Delta t_0 \right]$)第$i$枚烟幕干扰弹形成的烟幕云团是否对目标进行遮挡的判断条件$\Delta _{FYji}\left( x_l,y_l,z_s \right) $。并由\eqref{1.19}式可知
...
\begin{align}\label{14.907}
	\Delta _{FYji}\left( x_l,y_l,z_s \right) 
