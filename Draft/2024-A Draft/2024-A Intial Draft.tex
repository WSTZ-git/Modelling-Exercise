...
即
\begin{align*}
v_0\left( t-\frac{L}{v_0} \right) =\frac{d_0}{4\pi}\left[ \theta _{P_0}(t)\sqrt{\left( \theta _{P_0}(t) \right) ^2+1}-\theta _N\sqrt{\theta _{N}^{2}+1}+\ln \frac{\theta _{P_0}(t)+\sqrt{\left( \theta _{P_0}(t) \right) ^2+1}}{\theta _N+\sqrt{\theta _{N}^{2}+1}} \right].
\end{align*}
由上式解得$P_0$的位置坐标.
