...
\begin{align}
\theta _1(t) =\underset{\alpha _j(t) \in A}{\min}[\,\alpha _{j}^{1}(t) -\theta _0(t)] +\theta _0(t).
\end{align}
...
\begin{align}
\theta _i(t) =\underset{\alpha _{j}^{i}(t) \in A_i}{\min}[\alpha _{j}^{i}(t) -\theta _{i - 1}(t)] +\theta _{i - 1}(t).    
\end{align}
